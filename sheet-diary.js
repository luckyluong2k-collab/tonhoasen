...
$('rows').onclick=e=>{const b=e.target.closest('[data-act]');if(!b)return;const tr=b.closest('tr'),i=+tr.dataset.i;if(b.dataset.act==='save')saveIndex(i);if(b.dataset.act==='delete')deleteIndex(i)};
