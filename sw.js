...
const CACHE_NAME = 'hsh-phuly-v10.17';
...
const ASSETS_TO_CACHE = [
  ...
  './responsive.css?v=10.8',
  './responsive.js?v=10.5',
  './dossier-editor.html',
  './dossier-editor.css',
  './dossier-editor.js',
  './dossier-editor.js?v=10.10',
  './dossier-editor.css?v=10.6',
  './dossier-template-layout.js?v=10.2',
  './dossier-history.js?v=10.7',
  './dossier-drive.js?v=1.1',
