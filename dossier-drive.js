...
window.HSHDrive={get connected(){return connected();},connect,reserveId,findExisting,save,verify,list,describe,download,listBackups,uploadBackup,downloadBackup};
